...
public class DiscordRichPresence extends Structure
{
    ...
    public boolean equals(Object o)
    {
        ...
        return startTimestamp == presence.startTimestamp
                ...
                && state.equals( presence.state)
                && details.equals( presence.details)
                && largeImageKey.equals( presence.largeImageKey)
                && largeImageText.equals( presence.largeImageText)
                && smallImageKey.equals( presence.smallImageKey)
                && smallImageText.equals( presence.smallImageText)
                && partyId.equals( presence.partyId)
                && matchSecret.equals( presence.matchSecret)
                && joinSecret.equals( presence.joinSecret)
                && spectateSecret.equals( presence.spectateSecret);
    }

    @Override
    public int hashCode()
    {
        return Arrays.hashCode(new String[] {state, details, String.valueOf(startTimestamp), String.valueOf(endTimestamp), largeImageKey, largeImageText, smallImageKey,
                smallImageText, partyId, String.valueOf(partySize), String.valueOf(partyMax), matchSecret, joinSecret, spectateSecret, String.valueOf(instance)});
    }
